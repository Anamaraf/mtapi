...
_DLLAPI bool _stdcall initExpert(int expertHandle, int port, wchar_t* symbol, double bid, double ask, int isTestMode, wchar_t* err)
{
    return Execute<bool>([&expertHandle, &port, symbol, &bid, &ask, &isTestMode]() {
...
_DLLAPI bool _stdcall sendULongResponse(int expertHandle, unsigned __int64 response, wchar_t* err)
{
    return Execute<bool>([&expertHandle, &response]() {
...
_DLLAPI bool _stdcall sendBooleanResponse(int expertHandle, int response, wchar_t* err)
{
    return Execute<bool>([&expertHandle, &response]() {
...
_DLLAPI bool _stdcall sendLongArrayResponse(int expertHandle, __int64* values, int size, wchar_t* err)
{
    return Execute<bool>([&expertHandle, values, &size]() {
...
_DLLAPI bool _stdcall sendMqlRatesArrayResponse(int expertHandle, CMqlRates values[], int size, wchar_t* err)
{
    return Execute<bool>([&expertHandle, values, &size]() {
...
_DLLAPI bool _stdcall getULongValue(int expertHandle, int paramIndex, unsigned __int64& res, wchar_t* err)
{
    return Execute<bool>([&expertHandle, &paramIndex, &res]() {
...
_DLLAPI bool _stdcall getUIntValue(int expertHandle, int paramIndex, unsigned int& res, wchar_t* err)
{
    return Execute<bool>([&expertHandle, &paramIndex, &res]() {
